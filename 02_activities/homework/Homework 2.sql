...
--Using the product table, write a query that outputs the product_id and product_name columns and 
--add a column called prod_qty_type_condensed that displays the word “unit” if the product_qty_type is “unit",
...
--1.Write a query that INNER JOINs the vendor table to the vendor_booth_assignments table
